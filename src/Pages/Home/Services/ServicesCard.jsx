    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 res-padding py-10 w-11/12 mx-auto ">
        ...
        {ServiceData.map((service, index) => {
          ...
          return (
            <div key={index} className="card bg-base-100 shadow-xl rounded-2xl text-center hover:bg-lime-300 transition-colors ease-in-out duration-500">

              <div className="card-body justify-center items-center py-8 px-8">
                <Icon className="w-12 h-12 text-lime-500 mb-2 bg-base-300 p-3 rounded-full" />
                <h2 className="card-title font-bold text-xl">{service.title}</h2>
